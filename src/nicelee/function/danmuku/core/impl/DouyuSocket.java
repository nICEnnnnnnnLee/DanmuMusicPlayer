...
public class DouyuSocket implements Runnable {
	...
	public DouyuSocket(long roomId, long realRoomId, List<IMsgHandler> handlers) {
		this.roomId = roomId;
...
//			System.out.println("连接存活时长： " + (timeEnd - timeBegin) / 1000);
			throw e;
		}
...
//					}
		...
		System.out.println(realRoomId + " - Douyu弹幕接收进程结束");
	}
